...
def p_catch_from_neighbor() :
    print "TODO: Cells assumign 8 neighbors for destruction estimation"
    num_potential_neighbors = 8
    ...
    for num_developed_neighbors in range(num_potential_neighbors) : 
        ...
        for num_ignited_devel_neighbors in range(num_developed_neighbors+1) :
            devel_tuples.append((num_ignited_devel_neighbors,
                                devel_binom.pmf(num_ignited_devel_neighbors)))
        ...
        # print "devel tuples", devel_tuples
        # print "wild_tupes", wild_tuples
...
class Cell(object) :
    ...
    def neighbor_modulated_rent(self, neighbor_density) :
        return self.rent * (1+neighbor_density)
